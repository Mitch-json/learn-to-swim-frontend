    ...
    return (
        <div className="sidebar">
                ...
                <ul className="sidebar-list">
                    <li key={"1"} id="home" className="home-nav sidebar-list-item active">
                        <Link to="/admin/home">
                    ...
                    <li key={"2"} id="clients" className="clients-nav sidebar-list-item">
                    ...
                    <li key={"3"} id="pricing" className="pricing-nav sidebar-list-item">
                ...
                <div className="account-info-picture">
                    <img src="https://images.unsplash.com/photo-1527736947477-2790e28f3443?ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTE2fHx3b21hbnxlbnwwfHwwfHw%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=900&q=60" alt="Account"></img>
                </div>
                <div className="account-info-name">{props.username}</div>
